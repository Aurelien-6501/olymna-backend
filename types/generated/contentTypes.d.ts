...
export interface ApiCoachingCoaching extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_heure: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    nb_places: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    reservations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reservation.reservation'
    >;
    salle: Schema.Attribute.Enumeration<['Grande', 'Petite']>;
    titre: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    statut: Schema.Attribute.Enumeration<['confirm\u00E9e', 'annul\u00E9e']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
